        ...
        <div className="Homeessen">
            ...
            <div className="rounded-circle" >
                ...
                <div className="card-body">
                    <a href="/"><span style={{color: "black", fontSize: "15px"}}>Chimneys</span></a>
                </div>
                </div>
                <div className="rounded-circle">
                ...
                <div className="card-body">
                    <a href="/"><span style={{color: "black", fontSize: "15px"}}>Cookers</span></a>
                ...
                <div className="card-body">
                    <a href="/"><span style={{color: "black", fontSize: "15px"}}>Gas Stoves</span></a>
                ...
                <div className="card-body">
                    <a href="/"><span style={{color: "black", fontSize: "15px"}}>Towels</span></a>
                </div>
                </div>
                <div className="rounded-circle">
                ...
                <div className="card-body">
                    <a href="/"><span style={{color: "black", fontSize: "15px"}}>Mattresses</span></a>
                </div>
                </div>
                <div className="rounded-circle">
                ...
                <div className="card-body">
                   <a href="/"> <span style={{color: "black", fontSize: "15px"}}>Irons</span></a>
                </div>
                </div>
                <div className="rounded-circle">
                ...
                <div className="card-body">
                    <a href="/"><span style={{color: "black",fontSize: "15px"}}>Choppers</span></a>
                </div>
                </div>
                <div className="rounded-circle">
                ...
                <div className="card-body">
                    <a href="/"><span style={{color: "black", fontSize: "15px"}}>Extension C...</span></a>
                </div>
                </div>
