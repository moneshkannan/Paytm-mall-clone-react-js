        ...
        <div className="Electrobest">
            ...
            <div className="card-deck" style={{alignItems:"center", justifyContent:"space-evenly", display:"flex", marginLeft:"2rem", marginRight:"2rem", marginBottom:"3rem",marginTop:"2rem"}}>
                <div className="card parent" style={{width: "5rem", border:"none"}}>
                    <a href="/"><img style={{marginBottom:"3.4rem"}} src="https://assetscdn1.paytm.com/images/catalog/product/C/CO/COMBOAT-ROCKERZCLIC252498B030EDE0/0..jpg?imwidth=280&impolicy=hq" className="card-img-top child" alt=".."/></a>
                    <div className="price">
                ...
                <div className="card parent" style={{width: "5rem", border:"none"}}>
                    <a href="/"><img style={{marginBottom:"3.8rem"}} src="https://assetscdn1.paytm.com/images/catalog/product/M/MO/MOBJBL-C50HI-INE-PL2276490780A32/1569223111458_11.jpg?imwidth=280&impolicy=hq" className="card-img-top child" alt=".."/></a>
                    <div className="price">
                ...
                <div className="card parent" style={{width: "5rem", border:"none"}}>
                    <a href="/"><img style={{marginBottom:"3rem"}}src="https://assetscdn1.paytm.com/images/catalog/product/C/CO/COMBOVTY-M-9-MAJIND2584923AE4DCD5/1588385302965_2.jpg?imwidth=280&impolicy=hq" className="card-img-top child" alt=".."/></a>
                    <div className="price">
