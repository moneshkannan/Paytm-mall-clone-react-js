    ...
    return (
        ...
        <div className="rounded-circle" >
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black", fontSize: "15px"}}>Edible Oils</span></a>
            </div>
            </div>
            <div className="rounded-circle">
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black", fontSize: "15px"}}>Pet Food</span></a>
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black", fontSize: "15px"}}>Deo & perf..</span></a>
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black", fontSize: "15px"}}>Masks</span></a>
            </div>
            </div>
            <div className="rounded-circle">
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black", fontSize: "15px"}}>Almonds</span></a>
            </div>
            </div>
            <div className="rounded-circle">
            ...
            <div className="card-body">
               <a href="/"> <span style={{color: "black", fontSize: "15px"}}>Tea & coffee</span></a>
            </div>
            </div>
            <div className="rounded-circle">
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black",fontSize: "15px"}}>Face Wash</span></a>
            </div>
            </div>
            <div className="rounded-circle">
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black", fontSize: "15px"}}>Sanitizers</span></a>
            </div>
            </div>
            <div className="rounded-circle">
            ...
            <div className="card-body">
                <a href="/"><span style={{color: "black", fontSize: "15px"}}>Bp Monitors</span></a>
            </div>
            </div>
